...
GIFEncoder = function () {
  ...
  var setRepeat = (exports.setRepeat = function setRepeat(
    iter /*int*/ /*void*/,
  ) {
  ...
  var setTransparent = (exports.setTransparent = function setTransparent(
    c /*Number*/ /*void*/,
  ) {
    transparent = c;
  });
  ...
  var setFrameRate = (exports.setFrameRate = function setFrameRate(
    fps /*Number*/ /*void*/,
  ) {
  ...
  var analyzePixels = function analyzePixels /*void*/() {
    ...
    if (initColorTab.length > 256) {
      ...
      k = 0;
      for (var j /*int*/ = 0; j < nPix; j++) {
        var index /*int*/ = colorTab.indexOf(
          ((pixels[k++] & 0xff) << 16) +
            ((pixels[k++] & 0xff) << 8) +
            (pixels[k++] & 0xff),
        );
  ...
  var writePixels = function writePixels /*void*/() {
    var myencoder /*LZWEncoder*/ = new LZWEncoder(
      width,
      height,
      indexedPixels,
      colorDepth,
