      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {games.map((game) => (
            <div
              key={game.id}
              className="panel rounded-lg overflow-hidden hover:scale-105 transition-transform"
            >
              <Link href={game.url}>
              ...
              <div className="p-4 bg-puzzlescript-panel">
                <Link
                  href={game.url}
                  className="font-bold text-white hover:text-puzzlescript-highlight"
                >
                  {game.title}
                </Link>
