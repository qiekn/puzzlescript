    ...
    switch (state.section) {
      case "objects": {
        ...
        if (state.objects_section == 1) {
          ...
          let max_line_number =
            state.original_line_numbers[max_line_number_name_lowercase];
          for (var i = 1; i < object_names_lowercase.length; i++) {
            ...
            if (
              this_line_number !== state.lineNumber &&
              this_line_number > max_line_number
            ) {
          ...
          var previous_object_data =
            state.objects[max_line_number_name_lowercase];
          var previous_object_casename =
            state.original_case_names[max_line_number_name_lowercase];
        ...
        if (curWord === "->" || curWord === "-") {
          ...
          if (previous_arrow_idx >= 0) {
            ...
            if (right_of_cursor.trim().length === 0) {
              ...
              var excerpt = lineToCursor.substring(
                first_half_start,
                first_half_end + 1,
              );
